...
public class NLJoin implements DBIterator {
     ...
     * @throws Exception if opening of the underlying relations failed
     */
    @Override
    public String[] open() throws Exception {
        this.leftAttributes = new ArrayList<>(Arrays.asList(this.left.open()));
        this.rightAttributes = new ArrayList<>(
                Arrays.asList(this.right.open()));
     ...
     * 
     * @return the next tuple of the joined relation.
     * @throws Exception if retrieving tuples from the underlying relations 
     *         failed
     */
    @Override
