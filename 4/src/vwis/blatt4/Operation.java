...
public enum Operation {
    ...
    /**
     * Retrieves the names of the remote relation
     */
    Names,

    /**
     * Sends a filter to the remote relation.
     */
    Filter,
     ...
     *
     * @param socket
     *            the socket to request the operation over
     * @throws IOException
     ...
     *
     * @param socket
     *            the socket to receive the operation from
     ...
     */
    static public Operation receiveFrom(final Socket socket)
            throws IOException, UnknownOperationException {
     ...
     *
     * @param in
     *            the stream to readFrom from
     * @return the readFrom operation
     * @throws IOException
     *             if reading failed
     * @throws UnknownOperationException
     *             if an unknown operation code was readFrom
     */
    static public Operation readFrom(final InputStream in) throws IOException,
        ...
        if (readByte == -1) {
            ...
            try {
                ...
                throw new UnknownOperationException(String.format(
                        "Unknown operation code: %s", readByte), error);
            }
        }
    }
}
