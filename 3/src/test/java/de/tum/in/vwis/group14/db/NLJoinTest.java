...
public class NLJoinTest {
    ...
    private final static String[] LEFT_NAMES = new String[] { "id", "name",
            "height" };
    private final static String[] RIGHT_NAMES = new String[] { "id", "name",
            "age" };
    private final static String[] JOIN_NAMES = new String[] { "id", "name",
            "height", "age" };
